...
__device__ inline float cndGPU_F(float d)
{
...
__device__ inline void BlackScholesBodyGPU_F(
    float &CallResult,
    float &PutResult,
    float S, //Stock price
