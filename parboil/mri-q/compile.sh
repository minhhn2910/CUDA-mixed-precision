...
rm build_cuda/*.o
g++ -O2  -I./parboil_common/include -I$CUDA_PATH/include  -c ./cuda/file.cc -o build_cuda/file.o
$CUDA_PATH/bin/nvcc ./cuda/main.cu -O2 -I./parboil_common/include -I$CUDA_PATH/include  -c -o build_cuda/main.o
